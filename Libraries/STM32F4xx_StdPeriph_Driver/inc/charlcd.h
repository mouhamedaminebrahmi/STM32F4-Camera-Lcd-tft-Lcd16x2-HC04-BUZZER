...
#define Set_RS GPIO_SetBits(GPIOA,GPIO_Pin_7)
#define Clr_RS GPIO_ResetBits(GPIOA,GPIO_Pin_7)

#define Set_RW GPIO_SetBits(GPIOA,GPIO_Pin_8)
#define Clr_RW GPIO_ResetBits(GPIOA,GPIO_Pin_8)

#define Set_En GPIO_SetBits(GPIOA,GPIO_Pin_9)
#define Clr_En GPIO_ResetBits(GPIOA,GPIO_Pin_9)

// May use pwm and a transistor on the 5V rail in the final version
#define Backlight_On GPIO_SetBits(GPIOB,GPIO_Pin_10)
#define Backlight_Off GPIO_ResetBits(GPIOB,GPIO_Pin_10)
